 ...
 * <b>description:</b> FFTdeprecated class for real signals. Upon entry, N contains the
...
public class FFTdeprecated {
	...
	public void computeFFT(float signal[]) {
		...
		// perform FFTdeprecated using the real & imag array
		FFTRun();
	}
	...
	private void FFTRun() {
		...
		int j = halfNumPoints;
		// FFTdeprecated time domain decomposition carried out by "bit reversal sorting"
		// algorithm
		int k = 0;
